...
<template>
    <div class="login-wraper">
        ...
        <div class="login-options">
            <p class="login-option-line">Forgot password? <RouterLink to=""><span class="login-options-links">Click here</span></RouterLink></p>
            <p class="login-option-line">Don't have an account? <RouterLink to=""><span class="login-options-links">Register now</span></RouterLink></p>
        </div>
